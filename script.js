...
let list=[
  {
    ...
    "name": "Маслюк",
    "img": "img/mush7.png",
    "description": "Цей гриб має гладку, клейку шапку, зазвичай жовтого або коричневого кольору. Його легко розпізнати по слизистій поверхні, особливо після дощу. Росте переважно в хвойних лісах. Дуже популярний і смачний їстівний гриб.",
    "isGood": true
  },
  {
    "id": 2,
    "name": "Боровик",
    "img": "img/mush8.png",
    "description": "Один із найцінніших грибів, також відомий як білий гриб. Має товсту, м'ясисту шапку коричневого кольору і міцну ніжку. Його м'якоть не змінює колір на зрізі. Використовується для сушіння, маринування та смаження.",
    "isGood": true
  },
  {
    "id": 3,
    "name": "Сироїжка",
    "img": "img/mush9.png",
    "description": "Цей гриб отримав свою назву через те, що його можна їсти сирим (після соління). Його шапка може бути різних кольорів: червоною, жовтою, зеленою або фіолетовою. Це один з найпоширеніших грибів в українських лісах.",
    "isGood": true
  },
  {
    "id": 4,
    "name": "Печериця",
    "img": "img/mush10.png",
    "description": "Цей гриб, також відомий як шампіньйон, є одним з найпопулярніших у світі. Він має білу або коричневу шапку і рожеві або коричневі пластинки під нею. Використовується в кулінарії повсюдно.",
    "isGood": true
  },
  {
    "id": 5,
    ...
    "img": "img/mush11.jpg",
    "description": "Один з найвідоміших отруйних грибів, що має яскраво-червону шапку з білими плямами. На ніжці є кільце, а біля основи — потовщення. Гриб дуже отруйний, але відіграє важливу роль в екосистемі лісу.",
    "isGood": false
  },
  {
    "id": 6,
    "name": "Бліда поганка",
    "img": "img/mush12.jpg",
    "description": "Вважається одним з найнебезпечніших грибів у світі. Має бліду, зеленувато-сіру шапку, білу ніжку з кільцем і вольвою біля основи. Отрута, що міститься в грибі, смертельна навіть у невеликих дозах.",
    "isGood": false
  }
]
